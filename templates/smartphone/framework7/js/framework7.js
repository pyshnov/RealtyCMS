    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.showIndicator = function () {
            ...
            app.root.append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preloader preloader-green">' + (app.params.material ? app.params.materialPreloaderHtml : '') + '</span></div>');
        };
        ...
        ************   Swipe panels   ************
        ...
        app.initSwipePanels = function () {
            ...
            function handleTouchStart(e) {
                ...
                if ($(e.target).closest('.swipe-panel-ignore').length > 0) return;
